...
library TendermintTypesPart {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      if (fieldId == 2) {
        pointer += _read_f_bytes(pointer, bs, r);
      } else
      if (fieldId == 3) {
  ...
  function _read_proof(
    ...
    (TendermintCryptoProof.Data memory x, uint256 sz) = _decode_TendermintCryptoProof(p, bs);
    r.proof = x;
    return sz;
  }
   ...
   */
  function _decode_TendermintCryptoProof(uint256 p, bytes memory bs)
    internal
    pure
    returns (TendermintCryptoProof.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (TendermintCryptoProof.Data memory r, ) = TendermintCryptoProof._decode(pointer, bs, sz);
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_bytes(r.f_bytes, pointer, bs);
    }
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(r.f_bytes.length);
    e += 1 + ProtoBufRuntime._sz_lendelim(TendermintCryptoProof._estimate(r.proof));
    return e;
  }
  // empty checker
...
library TendermintTypesBlockID {
  ...
  function _read_part_set_header(
    ...
    (TendermintTypesPartSetHeader.Data memory x, uint256 sz) = _decode_TendermintTypesPartSetHeader(p, bs);
    r.part_set_header = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_TendermintTypesPartSetHeader(uint256 p, bytes memory bs)
    internal
    pure
    returns (TendermintTypesPartSetHeader.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (TendermintTypesPartSetHeader.Data memory r, ) = TendermintTypesPartSetHeader._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += TendermintTypesPartSetHeader._encode_nested(r.part_set_header, pointer, bs);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(r.hash.length);
    e += 1 + ProtoBufRuntime._sz_lendelim(TendermintTypesPartSetHeader._estimate(r.part_set_header));
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    output.hash = input.hash;
    TendermintTypesPartSetHeader.store(input.part_set_header, output.part_set_header);
...
library TendermintTypesVote {
  ...
  //struct definition
  struct Data {
    TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS.SignedMsgType f_type;
    int64 height;
    int32 round;
  ...
  function _read_f_type(
    ...
    TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS.SignedMsgType x = TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS.decode_SignedMsgType(tmp);
    r.f_type = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_f_type = TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS.encode_SignedMsgType(r.f_type);
    pointer += ProtoBufRuntime._encode_enum(_enum_f_type, pointer, bs);
    }
    if (r.height != 0) {
    pointer += ProtoBufRuntime._encode_key(
      2,
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_enum(TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS.encode_SignedMsgType(r.f_type));
    e += 1 + ProtoBufRuntime._sz_int64(r.height);
...
library TendermintTypesCommit {
  ...
  function _read_unpacked_repeated_signatures(
     ...
     * if `r` is NULL, then only counting the number of fields.
     */
    (TendermintTypesCommitSig.Data memory x, uint256 sz) = _decode_TendermintTypesCommitSig(p, bs);
    if (isNil(r)) {
      counters[4] += 1;
    } else {
   ...
   * @return The number of bytes used to decode
   */
  function _decode_TendermintTypesCommitSig(uint256 p, bytes memory bs)
    internal
    pure
    returns (TendermintTypesCommitSig.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (TendermintTypesCommitSig.Data memory r, ) = TendermintTypesCommitSig._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    for(i = 0; i < r.signatures.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += TendermintTypesCommitSig._encode_nested(r.signatures[i], pointer, bs);
    }
    }
    return pointer - offset;
  }
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(TendermintTypesBlockID._estimate(r.block_id));
    for(i = 0; i < r.signatures.length; i++) {
      e += 1 + ProtoBufRuntime._sz_lendelim(TendermintTypesCommitSig._estimate(r.signatures[i]));
    }
    return e;
  }
  // empty checker
   ...
   * @param value The value to add
   */
  function addSignatures(Data memory self, TendermintTypesCommitSig.Data memory value) internal pure {
    /**
     * First resize the array. Then add the new element to the end.
     */
    TendermintTypesCommitSig.Data[] memory tmp = new TendermintTypesCommitSig.Data[](self.signatures.length + 1);
...
library TendermintTypesCommitSig {
  ...
  //struct definition
  struct Data {
    TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS.BlockIDFlag block_id_flag;
    bytes validator_address;
    GoogleProtobufTimestamp.Data timestamp;
    bytes signature;
  }
  ...
  function _read_block_id_flag(
    ...
    (int64 tmp, uint256 sz) = ProtoBufRuntime._decode_enum(p, bs);
    TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS.BlockIDFlag x = TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS.decode_BlockIDFlag(tmp);
    r.block_id_flag = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_block_id_flag = TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS.encode_BlockIDFlag(r.block_id_flag);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_enum(TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS.encode_BlockIDFlag(r.block_id_flag));
    e += 1 + ProtoBufRuntime._sz_lendelim(r.validator_address.length);
    e += 1 + ProtoBufRuntime._sz_lendelim(GoogleProtobufTimestamp._estimate(r.timestamp));
    e += 1 + ProtoBufRuntime._sz_lendelim(r.signature.length);
    return e;
...
library TendermintTypesSignedHeader {
  ...
  function _read_header(
    ...
    (TendermintTypesHeader.Data memory x, uint256 sz) = _decode_TendermintTypesHeader(p, bs);
    r.header = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_TendermintTypesHeader(uint256 p, bytes memory bs)
    internal
    pure
    returns (TendermintTypesHeader.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (TendermintTypesHeader.Data memory r, ) = TendermintTypesHeader._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(TendermintTypesHeader._estimate(r.header));
    e += 1 + ProtoBufRuntime._sz_lendelim(TendermintTypesCommit._estimate(r.commit));
    return e;
  }
  // empty checker
...
library TendermintTypesLightBlock {
  ...
  function _read_signed_header(
    ...
    (TendermintTypesSignedHeader.Data memory x, uint256 sz) = _decode_TendermintTypesSignedHeader(p, bs);
    r.signed_header = x;
    return sz;
  }
  ...
  function _read_validator_set(
    ...
    (TendermintTypesValidatorSet.Data memory x, uint256 sz) = _decode_TendermintTypesValidatorSet(p, bs);
    r.validator_set = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_TendermintTypesSignedHeader(uint256 p, bytes memory bs)
    internal
    pure
    returns (TendermintTypesSignedHeader.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (TendermintTypesSignedHeader.Data memory r, ) = TendermintTypesSignedHeader._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_TendermintTypesValidatorSet(uint256 p, bytes memory bs)
    internal
    pure
    returns (TendermintTypesValidatorSet.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (TendermintTypesValidatorSet.Data memory r, ) = TendermintTypesValidatorSet._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += TendermintTypesSignedHeader._encode_nested(r.signed_header, pointer, bs);
    ...
    pointer += TendermintTypesValidatorSet._encode_nested(r.validator_set, pointer, bs);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(TendermintTypesSignedHeader._estimate(r.signed_header));
    e += 1 + ProtoBufRuntime._sz_lendelim(TendermintTypesValidatorSet._estimate(r.validator_set));
    return e;
  }
  // empty checker
   ...
   */
  function store(Data memory input, Data storage output) internal {
    TendermintTypesSignedHeader.store(input.signed_header, output.signed_header);
    TendermintTypesValidatorSet.store(input.validator_set, output.validator_set);
...
library TENDERMINT_TYPES_TYPES_PROTO_GLOBAL_ENUMS {
   ...
   * @return The number of bytes encoded
   */
  function estimate_packed_repeated_BlockIDFlag(
    BlockIDFlag[] memory a
   ...
   * @return The number of bytes encoded
   */
  function estimate_packed_repeated_SignedMsgType(
    SignedMsgType[] memory a
  ) internal pure returns (uint256) {
    uint256 e = 0;
    for (uint i = 0; i < a.length; i++) {
