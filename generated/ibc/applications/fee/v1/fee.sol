...
library IbcApplicationsFeeV1Fee {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 1) {
        pointer += _read_unpacked_repeated_recv_fee(pointer, bs, nil(), counters);
      } else
      if (fieldId == 2) {
        pointer += _read_unpacked_repeated_ack_fee(pointer, bs, nil(), counters);
      } else
      if (fieldId == 3) {
        pointer += _read_unpacked_repeated_timeout_fee(pointer, bs, nil(), counters);
      } else
      {
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 1) {
        pointer += _read_unpacked_repeated_recv_fee(pointer, bs, r, counters);
      } else
      if (fieldId == 2) {
        pointer += _read_unpacked_repeated_ack_fee(pointer, bs, r, counters);
      } else
      if (fieldId == 3) {
        pointer += _read_unpacked_repeated_timeout_fee(pointer, bs, r, counters);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
    ...
    returns (uint)
  {
    ...
    for(i = 0; i < r.recv_fee.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += CosmosBaseV1beta1Coin._encode_nested(r.recv_fee[i], pointer, bs);
    }
    }
    ...
    for(i = 0; i < r.ack_fee.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += CosmosBaseV1beta1Coin._encode_nested(r.ack_fee[i], pointer, bs);
    }
    }
    ...
    for(i = 0; i < r.timeout_fee.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += CosmosBaseV1beta1Coin._encode_nested(r.timeout_fee[i], pointer, bs);
    }
    }
  ...
  function _estimate(
    ...
    uint256 e;uint256 i;
    for(i = 0; i < r.recv_fee.length; i++) {
      e += 1 + ProtoBufRuntime._sz_lendelim(CosmosBaseV1beta1Coin._estimate(r.recv_fee[i]));
    }
    for(i = 0; i < r.ack_fee.length; i++) {
      e += 1 + ProtoBufRuntime._sz_lendelim(CosmosBaseV1beta1Coin._estimate(r.ack_fee[i]));
    }
    for(i = 0; i < r.timeout_fee.length; i++) {
      e += 1 + ProtoBufRuntime._sz_lendelim(CosmosBaseV1beta1Coin._estimate(r.timeout_fee[i]));
    }
    return e;
  }
  // empty checker
   ...
   */
  function addRecvFee(Data memory self, CosmosBaseV1beta1Coin.Data memory value) internal pure {
    /**
     * First resize the array. Then add the new element to the end.
     */
    CosmosBaseV1beta1Coin.Data[] memory tmp = new CosmosBaseV1beta1Coin.Data[](self.recv_fee.length + 1);
   ...
   * @param value The value to add
   */
  function addAckFee(Data memory self, CosmosBaseV1beta1Coin.Data memory value) internal pure {
    /**
     * First resize the array. Then add the new element to the end.
     */
    CosmosBaseV1beta1Coin.Data[] memory tmp = new CosmosBaseV1beta1Coin.Data[](self.ack_fee.length + 1);
   ...
   * @param value The value to add
   */
  function addTimeoutFee(Data memory self, CosmosBaseV1beta1Coin.Data memory value) internal pure {
    /**
     * First resize the array. Then add the new element to the end.
     */
    CosmosBaseV1beta1Coin.Data[] memory tmp = new CosmosBaseV1beta1Coin.Data[](self.timeout_fee.length + 1);
...
library IbcApplicationsFeeV1PacketFee {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      if (fieldId == 3) {
        pointer += _read_unpacked_repeated_relayers(pointer, bs, nil(), counters);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 3) {
        pointer += _read_unpacked_repeated_relayers(pointer, bs, r, counters);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
  ...
  function _read_fee(
    ...
    (IbcApplicationsFeeV1Fee.Data memory x, uint256 sz) = _decode_IbcApplicationsFeeV1Fee(p, bs);
    r.fee = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcApplicationsFeeV1Fee(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcApplicationsFeeV1Fee.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcApplicationsFeeV1Fee.Data memory r, ) = IbcApplicationsFeeV1Fee._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.refund_address, pointer, bs);
    }
    ...
    for(i = 0; i < r.relayers.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += ProtoBufRuntime._encode_string(r.relayers[i], pointer, bs);
    }
    }
    return pointer - offset;
  }
  ...
  function _estimate(
    ...
    uint256 e;uint256 i;
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcApplicationsFeeV1Fee._estimate(r.fee));
...
library IbcApplicationsFeeV1PacketFees {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 1) {
        pointer += _read_unpacked_repeated_packet_fees(pointer, bs, nil(), counters);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
    ...
    if (counters[1] > 0) {
      ...
      r.packet_fees = new IbcApplicationsFeeV1PacketFee.Data[](counters[1]);
    }
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 1) {
        pointer += _read_unpacked_repeated_packet_fees(pointer, bs, r, counters);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
  ...
  function _read_unpacked_repeated_packet_fees(
     ...
     * if `r` is NULL, then only counting the number of fields.
     */
    (IbcApplicationsFeeV1PacketFee.Data memory x, uint256 sz) = _decode_IbcApplicationsFeeV1PacketFee(p, bs);
    if (isNil(r)) {
      counters[1] += 1;
    } else {
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcApplicationsFeeV1PacketFee(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcApplicationsFeeV1PacketFee.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcApplicationsFeeV1PacketFee.Data memory r, ) = IbcApplicationsFeeV1PacketFee._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    for(i = 0; i < r.packet_fees.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += IbcApplicationsFeeV1PacketFee._encode_nested(r.packet_fees[i], pointer, bs);
    }
    }
    return pointer - offset;
  }
  ...
  function _estimate(
    ...
    uint256 e;uint256 i;
    for(i = 0; i < r.packet_fees.length; i++) {
      e += 1 + ProtoBufRuntime._sz_lendelim(IbcApplicationsFeeV1PacketFee._estimate(r.packet_fees[i]));
    }
    return e;
  }
  // empty checker
   ...
   * @param value The value to add
   */
  function addPacketFees(Data memory self, IbcApplicationsFeeV1PacketFee.Data memory value) internal pure {
    /**
     * First resize the array. Then add the new element to the end.
     */
    IbcApplicationsFeeV1PacketFee.Data[] memory tmp = new IbcApplicationsFeeV1PacketFee.Data[](self.packet_fees.length + 1);
...
library IbcApplicationsFeeV1IdentifiedPacketFees {
    ...
    returns (Data memory, uint)
  {
    ...
    if (counters[2] > 0) {
      require(r.packet_fees.length == 0);
      r.packet_fees = new IbcApplicationsFeeV1PacketFee.Data[](counters[2]);
    }
