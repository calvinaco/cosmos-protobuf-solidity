...
library IbcApplicationsFeeV1MsgPayPacketFee {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.source_port_id, pointer, bs);
    }
    ...
    pointer += ProtoBufRuntime._encode_string(r.source_channel_id, pointer, bs);
    }
...
library IbcApplicationsFeeV1MsgPayPacketFeeAsync {
    ...
    returns (uint)
  {
    ...
    pointer += IbcApplicationsFeeV1PacketFee._encode_nested(r.packet_fee, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcApplicationsFeeV1PacketFee._estimate(r.packet_fee));
    return e;
  }
  // empty checker
