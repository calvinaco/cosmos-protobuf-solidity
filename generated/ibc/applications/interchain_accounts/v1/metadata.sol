...
library IbcApplicationsInterchain_accountsV1Metadata {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.controller_connection_id, pointer, bs);
    }
    ...
    pointer += ProtoBufRuntime._encode_string(r.host_connection_id, pointer, bs);
    }
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.controller_connection_id).length);
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.host_connection_id).length);
