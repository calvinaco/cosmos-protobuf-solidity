...
import "../../../../cosmos/auth/v1beta1/auth.sol";

library IbcApplicationsInterchain_accountsV1InterchainAccount {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.account_owner, pointer, bs);
    }
