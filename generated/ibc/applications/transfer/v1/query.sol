...
library IbcApplicationsTransferV1QueryDenomTraceRequest {
...
library IbcApplicationsTransferV1QueryDenomTraceResponse {


  //struct definition
  struct Data {
    IbcApplicationsTransferV1DenomTrace.Data denom_trace;
  }
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 1) {
        pointer += _read_denom_trace(pointer, bs, r);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
   ...
   * @return The number of bytes decoded
   */
  function _read_denom_trace(
    uint256 p,
    bytes memory bs,
    Data memory r
  ) internal pure returns (uint) {
    (IbcApplicationsTransferV1DenomTrace.Data memory x, uint256 sz) = _decode_IbcApplicationsTransferV1DenomTrace(p, bs);
    r.denom_trace = x;
    return sz;
  }
   ...
   */
  function _decode_IbcApplicationsTransferV1DenomTrace(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcApplicationsTransferV1DenomTrace.Data memory, uint)
  {
    ...
    pointer += bytesRead;
    (IbcApplicationsTransferV1DenomTrace.Data memory r, ) = IbcApplicationsTransferV1DenomTrace._decode(pointer, bs, sz);
    ...
    returns (uint)
  {
    ...
    pointer += IbcApplicationsTransferV1DenomTrace._encode_nested(r.denom_trace, pointer, bs);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcApplicationsTransferV1DenomTrace._estimate(r.denom_trace));
    return e;
  }
  // empty checker
   ...
   */
  function store(Data memory input, Data storage output) internal {
    IbcApplicationsTransferV1DenomTrace.store(input.denom_trace, output.denom_trace);
...
library IbcApplicationsTransferV1QueryDenomTracesRequest {
...
library IbcApplicationsTransferV1QueryDenomTracesResponse {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 1) {
        pointer += _read_unpacked_repeated_denom_traces(pointer, bs, nil(), counters);
      } else
      if (fieldId == 2) {
        pointer += _read_pagination(pointer, bs, r);
      } else
    ...
    if (counters[1] > 0) {
      ...
      r.denom_traces = new IbcApplicationsTransferV1DenomTrace.Data[](counters[1]);
    }
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 1) {
        pointer += _read_unpacked_repeated_denom_traces(pointer, bs, r, counters);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
  ...
  function _read_unpacked_repeated_denom_traces(
    ...
    if (isNil(r)) {
      ...
      r.denom_traces[r.denom_traces.length - counters[1]] = x;
      counters[1] -= 1;
    }
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    for(i = 0; i < r.denom_traces.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += IbcApplicationsTransferV1DenomTrace._encode_nested(r.denom_traces[i], pointer, bs);
    }
    }
  ...
  function _estimate(
    ...
    uint256 e;uint256 i;
    for(i = 0; i < r.denom_traces.length; i++) {
      e += 1 + ProtoBufRuntime._sz_lendelim(IbcApplicationsTransferV1DenomTrace._estimate(r.denom_traces[i]));
    }
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    for(uint256 i1 = 0; i1 < input.denom_traces.length; i1++) {
      output.denom_traces.push(input.denom_traces[i1]);
    }
   ...
   */
  function addDenomTraces(Data memory self, IbcApplicationsTransferV1DenomTrace.Data memory value) internal pure {
    /**
     * First resize the array. Then add the new element to the end.
     */
    IbcApplicationsTransferV1DenomTrace.Data[] memory tmp = new IbcApplicationsTransferV1DenomTrace.Data[](self.denom_traces.length + 1);
...
library IbcApplicationsTransferV1QueryParamsResponse {
  ...
  function _read_params(
    ...
    (IbcApplicationsTransferV1Params.Data memory x, uint256 sz) = _decode_IbcApplicationsTransferV1Params(p, bs);
    r.params = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcApplicationsTransferV1Params(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcApplicationsTransferV1Params.Data memory, uint)
  {
    ...
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcApplicationsTransferV1Params.Data memory r, ) = IbcApplicationsTransferV1Params._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += IbcApplicationsTransferV1Params._encode_nested(r.params, pointer, bs);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcApplicationsTransferV1Params._estimate(r.params));
    return e;
  }
  // empty checker
...
library IbcApplicationsTransferV1QueryDenomHashRequest {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 1) {
        pointer += _read_trace(pointer, bs, r);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.trace, pointer, bs);
    }
    return pointer - offset;
  }
  // nested encoder
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.trace).length);
    return e;
  }
  // empty checker
...
library IbcApplicationsTransferV1QueryDenomHashResponse {
...
library IbcApplicationsTransferV1QueryEscrowAddressRequest {
...
library IbcApplicationsTransferV1QueryEscrowAddressResponse {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 1) {
        pointer += _read_escrow_address(pointer, bs, r);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
    ...
    returns (uint)
  {
    ...
    if (bytes(r.escrow_address).length != 0) {
    pointer += ProtoBufRuntime._encode_key(
      1,
      ProtoBufRuntime.WireType.LengthDelim,
      pointer,
    ...
    pointer += ProtoBufRuntime._encode_string(r.escrow_address, pointer, bs);
    }
    return pointer - offset;
  }
  // nested encoder
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.escrow_address).length);
    return e;
  }
  // empty checker
   ...
   */
  function store(Data memory input, Data storage output) internal {
    output.escrow_address = input.escrow_address;
