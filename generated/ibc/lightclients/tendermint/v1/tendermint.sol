...
library IbcLightclientsTendermintV1ClientState {
  ...
  struct Data {
    ...
    Ics23ProofSpec.Data[] proof_specs;
    string[] upgrade_path;
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      if (fieldId == 8) {
        pointer += _read_unpacked_repeated_proof_specs(pointer, bs, nil(), counters);
      } else
      if (fieldId == 9) {
        pointer += _read_unpacked_repeated_upgrade_path(pointer, bs, nil(), counters);
      } else
      if (fieldId == 10) {
    ...
    if (counters[8] > 0) {
      ...
      r.proof_specs = new Ics23ProofSpec.Data[](counters[8]);
    }
    if (counters[9] > 0) {
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 8) {
        pointer += _read_unpacked_repeated_proof_specs(pointer, bs, r, counters);
      } else
      if (fieldId == 9) {
        pointer += _read_unpacked_repeated_upgrade_path(pointer, bs, r, counters);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
  ...
  function _read_trust_level(
    ...
    (IbcLightclientsTendermintV1Fraction.Data memory x, uint256 sz) = _decode_IbcLightclientsTendermintV1Fraction(p, bs);
    r.trust_level = x;
    return sz;
  }
  ...
  function _read_unpacked_repeated_proof_specs(
     ...
     */
    (Ics23ProofSpec.Data memory x, uint256 sz) = _decode_Ics23ProofSpec(p, bs);
    if (isNil(r)) {
      counters[8] += 1;
    } else {
   ...
   */
  function _decode_IbcLightclientsTendermintV1Fraction(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcLightclientsTendermintV1Fraction.Data memory, uint)
  {
    ...
    pointer += bytesRead;
    (IbcLightclientsTendermintV1Fraction.Data memory r, ) = IbcLightclientsTendermintV1Fraction._decode(pointer, bs, sz);
   ...
   * @return The number of bytes used to decode
   */
  function _decode_Ics23ProofSpec(uint256 p, bytes memory bs)
    internal
    pure
    returns (Ics23ProofSpec.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (Ics23ProofSpec.Data memory r, ) = Ics23ProofSpec._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += IbcLightclientsTendermintV1Fraction._encode_nested(r.trust_level, pointer, bs);
    ...
    pointer += GoogleProtobufDuration._encode_nested(r.unbonding_period, pointer, bs);
    ...
    for(i = 0; i < r.proof_specs.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += Ics23ProofSpec._encode_nested(r.proof_specs[i], pointer, bs);
    }
    }
    ...
    for(i = 0; i < r.upgrade_path.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += ProtoBufRuntime._encode_string(r.upgrade_path[i], pointer, bs);
    }
    }
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsTendermintV1Fraction._estimate(r.trust_level));
    ...
    for(i = 0; i < r.proof_specs.length; i++) {
      e += 1 + ProtoBufRuntime._sz_lendelim(Ics23ProofSpec._estimate(r.proof_specs[i]));
    }
    for(i = 0; i < r.upgrade_path.length; i++) {
      e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.upgrade_path[i]).length);
    }
    e += 1 + 1;
    e += 1 + 1;
    return e;
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    IbcLightclientsTendermintV1Fraction.store(input.trust_level, output.trust_level);
   ...
   */
  function addProofSpecs(Data memory self, Ics23ProofSpec.Data memory value) internal pure {
    /**
     * First resize the array. Then add the new element to the end.
     */
    Ics23ProofSpec.Data[] memory tmp = new Ics23ProofSpec.Data[](self.proof_specs.length + 1);
   ...
   * @param value The value to add
   */
  function addUpgradePath(Data memory self, string memory value) internal pure {
    /**
     * First resize the array. Then add the new element to the end.
     */
...
library IbcLightclientsTendermintV1ConsensusState {
  ...
  function _read_root(
    ...
    (IbcCoreCommitmentV1MerkleRoot.Data memory x, uint256 sz) = _decode_IbcCoreCommitmentV1MerkleRoot(p, bs);
    r.root = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcCoreCommitmentV1MerkleRoot(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcCoreCommitmentV1MerkleRoot.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcCoreCommitmentV1MerkleRoot.Data memory r, ) = IbcCoreCommitmentV1MerkleRoot._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += IbcCoreCommitmentV1MerkleRoot._encode_nested(r.root, pointer, bs);
...
library IbcLightclientsTendermintV1Misbehaviour {
  ...
  function _read_header_1(
    ...
    (IbcLightclientsTendermintV1Header.Data memory x, uint256 sz) = _decode_IbcLightclientsTendermintV1Header(p, bs);
    r.header_1 = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcLightclientsTendermintV1Header(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcLightclientsTendermintV1Header.Data memory, uint)
  {
    ...
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcLightclientsTendermintV1Header.Data memory r, ) = IbcLightclientsTendermintV1Header._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += IbcLightclientsTendermintV1Header._encode_nested(r.header_1, pointer, bs);
    ...
    pointer += IbcLightclientsTendermintV1Header._encode_nested(r.header_2, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsTendermintV1Header._estimate(r.header_1));
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsTendermintV1Header._estimate(r.header_2));
    return e;
  }
  // empty checker
...
library IbcLightclientsTendermintV1Header {
    ...
    returns (uint)
  {
    ...
    pointer += TendermintTypesValidatorSet._encode_nested(r.trusted_validators, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(TendermintTypesValidatorSet._estimate(r.trusted_validators));
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    TendermintTypesValidatorSet.store(input.trusted_validators, output.trusted_validators);
