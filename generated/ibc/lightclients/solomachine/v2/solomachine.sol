...
library IbcLightclientsSolomachineV2ClientState {
  ...
  struct Data {
    uint64 sequence;
    bool is_frozen;
    IbcLightclientsSolomachineV2ConsensusState.Data consensus_state;
  ...
  function _read_consensus_state(
    ...
    (IbcLightclientsSolomachineV2ConsensusState.Data memory x, uint256 sz) = _decode_IbcLightclientsSolomachineV2ConsensusState(p, bs);
    r.consensus_state = x;
    return sz;
  }
   ...
   */
  function _decode_IbcLightclientsSolomachineV2ConsensusState(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcLightclientsSolomachineV2ConsensusState.Data memory, uint)
  {
    ...
    pointer += bytesRead;
    (IbcLightclientsSolomachineV2ConsensusState.Data memory r, ) = IbcLightclientsSolomachineV2ConsensusState._decode(pointer, bs, sz);
    ...
    returns (uint)
  {
    ...
    pointer += IbcLightclientsSolomachineV2ConsensusState._encode_nested(r.consensus_state, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + 1;
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsSolomachineV2ConsensusState._estimate(r.consensus_state));
    e += 1 + 1;
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    IbcLightclientsSolomachineV2ConsensusState.store(input.consensus_state, output.consensus_state);
...
library IbcLightclientsSolomachineV2ConsensusState {
...
library IbcLightclientsSolomachineV2Header {
...
library IbcLightclientsSolomachineV2Misbehaviour {
  ...
  struct Data {
    string client_id;
    uint64 sequence;
    IbcLightclientsSolomachineV2SignatureAndData.Data signature_one;
    IbcLightclientsSolomachineV2SignatureAndData.Data signature_two;
  }
  ...
  function _read_signature_one(
    ...
    (IbcLightclientsSolomachineV2SignatureAndData.Data memory x, uint256 sz) = _decode_IbcLightclientsSolomachineV2SignatureAndData(p, bs);
    r.signature_one = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcLightclientsSolomachineV2SignatureAndData(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcLightclientsSolomachineV2SignatureAndData.Data memory, uint)
  {
    ...
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcLightclientsSolomachineV2SignatureAndData.Data memory r, ) = IbcLightclientsSolomachineV2SignatureAndData._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += IbcLightclientsSolomachineV2SignatureAndData._encode_nested(r.signature_one, pointer, bs);
    ...
    pointer += IbcLightclientsSolomachineV2SignatureAndData._encode_nested(r.signature_two, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_uint64(r.sequence);
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsSolomachineV2SignatureAndData._estimate(r.signature_one));
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsSolomachineV2SignatureAndData._estimate(r.signature_two));
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    output.sequence = input.sequence;
    IbcLightclientsSolomachineV2SignatureAndData.store(input.signature_one, output.signature_one);
    IbcLightclientsSolomachineV2SignatureAndData.store(input.signature_two, output.signature_two);
...
library IbcLightclientsSolomachineV2SignatureAndData {


  //struct definition
  struct Data {
    bytes signature;
    IBC/LIGHTCLIENTS/SOLOMACHINE/V2/SOLOMACHINE_PROTO_GLOBAL_ENUMS.DataType data_type;
    bytes data;
    uint64 timestamp;
  }
  ...
  function _read_data_type(
    ...
    IBC/LIGHTCLIENTS/SOLOMACHINE/V2/SOLOMACHINE_PROTO_GLOBAL_ENUMS.DataType x = IBC/LIGHTCLIENTS/SOLOMACHINE/V2/SOLOMACHINE_PROTO_GLOBAL_ENUMS.decode_DataType(tmp);
    r.data_type = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_data_type = IBC/LIGHTCLIENTS/SOLOMACHINE/V2/SOLOMACHINE_PROTO_GLOBAL_ENUMS.encode_DataType(r.data_type);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(r.signature.length);
    e += 1 + ProtoBufRuntime._sz_enum(IBC/LIGHTCLIENTS/SOLOMACHINE/V2/SOLOMACHINE_PROTO_GLOBAL_ENUMS.encode_DataType(r.data_type));
...
library IbcLightclientsSolomachineV2TimestampedSignatureData {
...
library IbcLightclientsSolomachineV2SignBytes {
...
library IbcLightclientsSolomachineV2HeaderData {
...
library IbcLightclientsSolomachineV2ClientStateData {
...
library IbcLightclientsSolomachineV2ConsensusStateData {
...
library IbcLightclientsSolomachineV2ConnectionStateData {
...
library IbcLightclientsSolomachineV2ChannelStateData {
...
library IbcLightclientsSolomachineV2PacketCommitmentData {
...
library IbcLightclientsSolomachineV2PacketReceiptAbsenceData {
...
library IbcLightclientsSolomachineV2NextSequenceRecvData {
...
library IBC/LIGHTCLIENTS/SOLOMACHINE/V2/SOLOMACHINE_PROTO_GLOBAL_ENUMS {
