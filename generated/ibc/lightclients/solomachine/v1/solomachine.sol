...
library IbcLightclientsSolomachineV1ClientState {
  ...
  struct Data {
    ...
    IbcLightclientsSolomachineV1ConsensusState.Data consensus_state;
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      if (fieldId == 2) {
        pointer += _read_frozen_sequence(pointer, bs, r);
      } else
      if (fieldId == 3) {
   ...
   * @return The number of bytes decoded
   */
  function _read_frozen_sequence(
    uint256 p,
    bytes memory bs,
    Data memory r
  ) internal pure returns (uint) {
  ...
  function _read_consensus_state(
    ...
    (IbcLightclientsSolomachineV1ConsensusState.Data memory x, uint256 sz) = _decode_IbcLightclientsSolomachineV1ConsensusState(p, bs);
    r.consensus_state = x;
    return sz;
  }
   ...
   * @return The number of bytes decoded
   */
  function _read_allow_update_after_proposal(
    uint256 p,
    bytes memory bs,
    Data memory r
  ) internal pure returns (uint) {
   ...
   */
  function _decode_IbcLightclientsSolomachineV1ConsensusState(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcLightclientsSolomachineV1ConsensusState.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcLightclientsSolomachineV1ConsensusState.Data memory r, ) = IbcLightclientsSolomachineV1ConsensusState._decode(pointer, bs, sz);
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_uint64(r.frozen_sequence, pointer, bs);
    }
    ...
    pointer += IbcLightclientsSolomachineV1ConsensusState._encode_nested(r.consensus_state, pointer, bs);
    ...
    pointer += ProtoBufRuntime._encode_bool(r.allow_update_after_proposal, pointer, bs);
    }
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_uint64(r.frozen_sequence);
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsSolomachineV1ConsensusState._estimate(r.consensus_state));
    e += 1 + 1;
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    output.frozen_sequence = input.frozen_sequence;
    IbcLightclientsSolomachineV1ConsensusState.store(input.consensus_state, output.consensus_state);
...
library IbcLightclientsSolomachineV1ConsensusState {
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(GoogleProtobufAny._estimate(r.public_key));
...
library IbcLightclientsSolomachineV1Header {
    ...
    returns (uint)
  {
    ...
    pointer += GoogleProtobufAny._encode_nested(r.new_public_key, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(GoogleProtobufAny._estimate(r.new_public_key));
...
library IbcLightclientsSolomachineV1Misbehaviour {
  ...
  struct Data {
    string client_id;
    uint64 sequence;
    IbcLightclientsSolomachineV1SignatureAndData.Data signature_one;
    IbcLightclientsSolomachineV1SignatureAndData.Data signature_two;
  }
  ...
  function _read_signature_one(
    ...
    (IbcLightclientsSolomachineV1SignatureAndData.Data memory x, uint256 sz) = _decode_IbcLightclientsSolomachineV1SignatureAndData(p, bs);
    r.signature_one = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcLightclientsSolomachineV1SignatureAndData(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcLightclientsSolomachineV1SignatureAndData.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcLightclientsSolomachineV1SignatureAndData.Data memory r, ) = IbcLightclientsSolomachineV1SignatureAndData._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += IbcLightclientsSolomachineV1SignatureAndData._encode_nested(r.signature_one, pointer, bs);
    ...
    pointer += IbcLightclientsSolomachineV1SignatureAndData._encode_nested(r.signature_two, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_uint64(r.sequence);
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsSolomachineV1SignatureAndData._estimate(r.signature_one));
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsSolomachineV1SignatureAndData._estimate(r.signature_two));
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    output.sequence = input.sequence;
    IbcLightclientsSolomachineV1SignatureAndData.store(input.signature_one, output.signature_one);
    IbcLightclientsSolomachineV1SignatureAndData.store(input.signature_two, output.signature_two);
...
library IbcLightclientsSolomachineV1SignatureAndData {


  //struct definition
  struct Data {
    bytes signature;
    IBC/LIGHTCLIENTS/SOLOMACHINE/V1/SOLOMACHINE_PROTO_GLOBAL_ENUMS.DataType data_type;
    bytes data;
    uint64 timestamp;
  }
  ...
  function _read_data_type(
    ...
    IBC/LIGHTCLIENTS/SOLOMACHINE/V1/SOLOMACHINE_PROTO_GLOBAL_ENUMS.DataType x = IBC/LIGHTCLIENTS/SOLOMACHINE/V1/SOLOMACHINE_PROTO_GLOBAL_ENUMS.decode_DataType(tmp);
    r.data_type = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_data_type = IBC/LIGHTCLIENTS/SOLOMACHINE/V1/SOLOMACHINE_PROTO_GLOBAL_ENUMS.encode_DataType(r.data_type);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(r.signature.length);
    e += 1 + ProtoBufRuntime._sz_enum(IBC/LIGHTCLIENTS/SOLOMACHINE/V1/SOLOMACHINE_PROTO_GLOBAL_ENUMS.encode_DataType(r.data_type));
...
library IbcLightclientsSolomachineV1TimestampedSignatureData {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_bytes(r.signature_data, pointer, bs);
    }
    if (r.timestamp != 0) {
    pointer += ProtoBufRuntime._encode_key(
      2,
...
library IbcLightclientsSolomachineV1SignBytes {
...
library IbcLightclientsSolomachineV1HeaderData {
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(GoogleProtobufAny._estimate(r.new_pub_key));
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.new_diversifier).length);
    return e;
  }
  // empty checker
...
library IbcLightclientsSolomachineV1ClientStateData {
...
library IbcLightclientsSolomachineV1ConsensusStateData {
...
library IbcLightclientsSolomachineV1ConnectionStateData {


  //struct definition
  struct Data {
    bytes path;
    IbcCoreConnectionV1ConnectionEnd.Data connection;
  }
  ...
  function _read_connection(
    ...
    (IbcCoreConnectionV1ConnectionEnd.Data memory x, uint256 sz) = _decode_IbcCoreConnectionV1ConnectionEnd(p, bs);
    r.connection = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcCoreConnectionV1ConnectionEnd(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcCoreConnectionV1ConnectionEnd.Data memory, uint)
  {
    ...
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcCoreConnectionV1ConnectionEnd.Data memory r, ) = IbcCoreConnectionV1ConnectionEnd._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += IbcCoreConnectionV1ConnectionEnd._encode_nested(r.connection, pointer, bs);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(r.path.length);
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreConnectionV1ConnectionEnd._estimate(r.connection));
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    output.path = input.path;
    IbcCoreConnectionV1ConnectionEnd.store(input.connection, output.connection);
...
library IbcLightclientsSolomachineV1ChannelStateData {
...
library IbcLightclientsSolomachineV1PacketCommitmentData {
...
library IbcLightclientsSolomachineV1PacketAcknowledgementData {
...
library IbcLightclientsSolomachineV1PacketReceiptAbsenceData {
...
library IbcLightclientsSolomachineV1NextSequenceRecvData {


  //struct definition
  struct Data {
    bytes path;
    uint64 next_seq_recv;
  }
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_uint64(r.next_seq_recv, pointer, bs);
    }
    return pointer - offset;
  }
  // nested encoder
  ...
  function store(Data memory input, Data storage output) internal {
    output.path = input.path;
    output.next_seq_recv = input.next_seq_recv;
...
library IBC/LIGHTCLIENTS/SOLOMACHINE/V1/SOLOMACHINE_PROTO_GLOBAL_ENUMS {
