...
library IbcCoreChannelV1MsgChannelOpenTry {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.previous_channel_id, pointer, bs);
    }
    ...
    pointer += ProtoBufRuntime._encode_string(r.counterparty_version, pointer, bs);
    }
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.port_id).length);
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.previous_channel_id).length);
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreChannelV1Channel._estimate(r.channel));
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.counterparty_version).length);
...
library IbcCoreChannelV1MsgChannelOpenAck {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.counterparty_channel_id, pointer, bs);
    }
    if (bytes(r.counterparty_version).length != 0) {
    pointer += ProtoBufRuntime._encode_key(
      4,
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.port_id).length);
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.channel_id).length);
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.counterparty_channel_id).length);
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.counterparty_version).length);
...
library IbcCoreChannelV1MsgRecvPacket {
  ...
  function _read_packet(
    ...
    (IbcCoreChannelV1Packet.Data memory x, uint256 sz) = _decode_IbcCoreChannelV1Packet(p, bs);
    r.packet = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcCoreChannelV1Packet(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcCoreChannelV1Packet.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcCoreChannelV1Packet.Data memory r, ) = IbcCoreChannelV1Packet._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_bytes(r.proof_commitment, pointer, bs);
    }
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreChannelV1Packet._estimate(r.packet));
...
library IbcCoreChannelV1MsgRecvPacketResponse {
  ...
  //struct definition
  struct Data {
    IBC/CORE/CHANNEL/V1/TX_PROTO_GLOBAL_ENUMS.ResponseResultType result;
  }
  ...
  function _read_result(
    ...
    IBC/CORE/CHANNEL/V1/TX_PROTO_GLOBAL_ENUMS.ResponseResultType x = IBC/CORE/CHANNEL/V1/TX_PROTO_GLOBAL_ENUMS.decode_ResponseResultType(tmp);
    r.result = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_result = IBC/CORE/CHANNEL/V1/TX_PROTO_GLOBAL_ENUMS.encode_ResponseResultType(r.result);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_enum(IBC/CORE/CHANNEL/V1/TX_PROTO_GLOBAL_ENUMS.encode_ResponseResultType(r.result));
    return e;
  }
  // empty checker
...
library IbcCoreChannelV1MsgTimeout {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_bytes(r.proof_unreceived, pointer, bs);
    }
    ...
    pointer += ProtoBufRuntime._encode_uint64(r.next_sequence_recv, pointer, bs);
    }
    if (bytes(r.signer).length != 0) {
    pointer += ProtoBufRuntime._encode_key(
      5,
...
library IBC/CORE/CHANNEL/V1/TX_PROTO_GLOBAL_ENUMS {
  ...
  function encode_ResponseResultType(ResponseResultType x) internal pure returns (int32) {
  ...
  function decode_ResponseResultType(int64 x) internal pure returns (ResponseResultType) {
