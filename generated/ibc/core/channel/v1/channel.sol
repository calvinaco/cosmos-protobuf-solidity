...
library IbcCoreChannelV1Channel {
  ...
  //struct definition
  struct Data {
    IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS.State state;
    IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS.Order ordering;
  ...
  function _read_state(
    ...
    IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS.State x = IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS.decode_State(tmp);
    r.state = x;
    return sz;
  }
  ...
  function _read_ordering(
    ...
    (int64 tmp, uint256 sz) = ProtoBufRuntime._decode_enum(p, bs);
    IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS.Order x = IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS.decode_Order(tmp);
    r.ordering = x;
    return sz;
  }
  ...
  function _read_counterparty(
    ...
    (IbcCoreChannelV1Counterparty.Data memory x, uint256 sz) = _decode_IbcCoreChannelV1Counterparty(p, bs);
    r.counterparty = x;
    return sz;
  }
   ...
   */
  function _decode_IbcCoreChannelV1Counterparty(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcCoreChannelV1Counterparty.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcCoreChannelV1Counterparty.Data memory r, ) = IbcCoreChannelV1Counterparty._decode(pointer, bs, sz);
    ...
    returns (uint)
  {
    ...
    int32 _enum_state = IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS.encode_State(r.state);
    ...
    int32 _enum_ordering = IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS.encode_Order(r.ordering);
    ...
    pointer += IbcCoreChannelV1Counterparty._encode_nested(r.counterparty, pointer, bs);
  ...
  function _estimate(
    ...
    uint256 e;uint256 i;
    e += 1 + ProtoBufRuntime._sz_enum(IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS.encode_State(r.state));
    e += 1 + ProtoBufRuntime._sz_enum(IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS.encode_Order(r.ordering));
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreChannelV1Counterparty._estimate(r.counterparty));
    for(i = 0; i < r.connection_hops.length; i++) {
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    IbcCoreChannelV1Counterparty.store(input.counterparty, output.counterparty);
...
library IBC/CORE/CHANNEL/V1/CHANNEL_PROTO_GLOBAL_ENUMS {
