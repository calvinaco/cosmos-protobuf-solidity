...
library IbcCoreConnectionV1MsgConnectionOpenInit {
  ...
  function _read_counterparty(
    ...
    (IbcCoreConnectionV1Counterparty.Data memory x, uint256 sz) = _decode_IbcCoreConnectionV1Counterparty(p, bs);
    r.counterparty = x;
    return sz;
  }
  ...
  function _read_version(
    ...
    (IbcCoreConnectionV1Version.Data memory x, uint256 sz) = _decode_IbcCoreConnectionV1Version(p, bs);
    r.version = x;
    return sz;
  }
   ...
   */
  function _decode_IbcCoreConnectionV1Counterparty(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcCoreConnectionV1Counterparty.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcCoreConnectionV1Counterparty.Data memory r, ) = IbcCoreConnectionV1Counterparty._decode(pointer, bs, sz);
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcCoreConnectionV1Version(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcCoreConnectionV1Version.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcCoreConnectionV1Version.Data memory r, ) = IbcCoreConnectionV1Version._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += IbcCoreConnectionV1Counterparty._encode_nested(r.counterparty, pointer, bs);
    ...
    pointer += IbcCoreConnectionV1Version._encode_nested(r.version, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreConnectionV1Counterparty._estimate(r.counterparty));
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreConnectionV1Version._estimate(r.version));
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    IbcCoreConnectionV1Counterparty.store(input.counterparty, output.counterparty);
...
library IbcCoreConnectionV1MsgConnectionOpenTry {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      if (fieldId == 6) {
        pointer += _read_unpacked_repeated_counterparty_versions(pointer, bs, nil(), counters);
      } else
      if (fieldId == 7) {
    ...
    if (counters[6] > 0) {
      ...
      r.counterparty_versions = new IbcCoreConnectionV1Version.Data[](counters[6]);
    }
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 6) {
        pointer += _read_unpacked_repeated_counterparty_versions(pointer, bs, r, counters);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
  ...
  function _read_unpacked_repeated_counterparty_versions(
    ...
    if (isNil(r)) {
      ...
      r.counterparty_versions[r.counterparty_versions.length - counters[6]] = x;
      counters[6] -= 1;
    }
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.previous_connection_id, pointer, bs);
    }
    ...
    for(i = 0; i < r.counterparty_versions.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += IbcCoreConnectionV1Version._encode_nested(r.counterparty_versions[i], pointer, bs);
    }
    }
    ...
    pointer += ProtoBufRuntime._encode_bytes(r.proof_client, pointer, bs);
    }
    ...
    pointer += ProtoBufRuntime._encode_bytes(r.proof_consensus, pointer, bs);
    }
    ...
    pointer += IbcCoreClientV1Height._encode_nested(r.consensus_height, pointer, bs);
  ...
  function _estimate(
    ...
    uint256 e;uint256 i;
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.client_id).length);
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.previous_connection_id).length);
    e += 1 + ProtoBufRuntime._sz_lendelim(GoogleProtobufAny._estimate(r.client_state));
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreConnectionV1Counterparty._estimate(r.counterparty));
    e += 1 + ProtoBufRuntime._sz_uint64(r.delay_period);
    for(i = 0; i < r.counterparty_versions.length; i++) {
      e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreConnectionV1Version._estimate(r.counterparty_versions[i]));
    }
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreClientV1Height._estimate(r.consensus_height));
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.signer).length);
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    IbcCoreClientV1Height.store(input.consensus_height, output.consensus_height);
    output.signer = input.signer;
   ...
   */
  function addCounterpartyVersions(Data memory self, IbcCoreConnectionV1Version.Data memory value) internal pure {
    /**
     * First resize the array. Then add the new element to the end.
     */
    IbcCoreConnectionV1Version.Data[] memory tmp = new IbcCoreConnectionV1Version.Data[](self.counterparty_versions.length + 1);
...
library IbcCoreConnectionV1MsgConnectionOpenAck {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.counterparty_connection_id, pointer, bs);
    }
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.counterparty_connection_id).length);
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreConnectionV1Version._estimate(r.version));
    e += 1 + ProtoBufRuntime._sz_lendelim(GoogleProtobufAny._estimate(r.client_state));
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcCoreClientV1Height._estimate(r.proof_height));
