...
library CosmosVestingV1beta1MsgCreateVestingAccount {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      if (fieldId == 5) {
        pointer += _read_delayed(pointer, bs, r);
      } else
      {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_bool(r.delayed, pointer, bs);
    }
...
library CosmosVestingV1beta1MsgCreateVestingAccountResponse {
...
library CosmosVestingV1beta1MsgCreatePermanentLockedAccount {
...
library CosmosVestingV1beta1MsgCreatePermanentLockedAccountResponse {
...
library CosmosVestingV1beta1MsgCreatePeriodicVestingAccount {
    ...
    returns (Data memory, uint)
  {
    ...
    if (counters[4] > 0) {
      ...
      r.vesting_periods = new CosmosVestingV1beta1Period.Data[](counters[4]);
    }
  ...
  function _read_unpacked_repeated_vesting_periods(
    ...
    if (isNil(r)) {
      ...
      r.vesting_periods[r.vesting_periods.length - counters[4]] = x;
      counters[4] -= 1;
    }
    return sz;
  }
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    for(uint256 i4 = 0; i4 < input.vesting_periods.length; i4++) {
      output.vesting_periods.push(input.vesting_periods[i4]);
    }
...
library CosmosVestingV1beta1MsgCreatePeriodicVestingAccountResponse {
