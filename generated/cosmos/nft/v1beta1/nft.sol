...
library CosmosNftV1beta1Class {
    ...
    returns (uint)
  {
    ...
    pointer += GoogleProtobufAny._encode_nested(r.data, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(GoogleProtobufAny._estimate(r.data));
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    GoogleProtobufAny.store(input.data, output.data);
