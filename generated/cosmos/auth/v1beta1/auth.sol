...
library CosmosAuthV1beta1BaseAccount {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_uint64(r.account_number, pointer, bs);
    }
    if (r.sequence != 0) {
    pointer += ProtoBufRuntime._encode_key(
      4,
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(GoogleProtobufAny._estimate(r.pub_key));
...
library CosmosAuthV1beta1ModuleAccount {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      if (fieldId == 3) {
        pointer += _read_unpacked_repeated_permissions(pointer, bs, nil(), counters);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
    ...
    while (pointer < offset + sz) {
      ...
      pointer += bytesRead;
      if (fieldId == 3) {
        pointer += _read_unpacked_repeated_permissions(pointer, bs, r, counters);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
    ...
    returns (uint)
  {
    ...
    for(i = 0; i < r.permissions.length; i++) {
      pointer += ProtoBufRuntime._encode_key(
        ...
        bs)
      ;
      pointer += ProtoBufRuntime._encode_string(r.permissions[i], pointer, bs);
    }
    }
    return pointer - offset;
  }
  ...
  function _estimate(
    ...
    for(i = 0; i < r.permissions.length; i++) {
      e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.permissions[i]).length);
    }
    return e;
  }
  // empty checker
   ...
   */
  function addPermissions(Data memory self, string memory value) internal pure {
    /**
...
library CosmosAuthV1beta1Params {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_uint64(r.max_memo_characters, pointer, bs);
    }
    if (r.tx_sig_limit != 0) {
    pointer += ProtoBufRuntime._encode_key(
      2,
    ...
    pointer += ProtoBufRuntime._encode_uint64(r.tx_sig_limit, pointer, bs);
    }
    ...
    pointer += ProtoBufRuntime._encode_uint64(r.tx_size_cost_per_byte, pointer, bs);
    }
    ...
    pointer += ProtoBufRuntime._encode_uint64(r.sig_verify_cost_ed25519, pointer, bs);
    }
    ...
    pointer += ProtoBufRuntime._encode_uint64(r.sig_verify_cost_secp256k1, pointer, bs);
    }
    return pointer - offset;
  }
  // nested encoder
