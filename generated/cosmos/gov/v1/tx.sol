...
library CosmosGovV1MsgSubmitProposal {
...
library CosmosGovV1MsgSubmitProposalResponse {
...
library CosmosGovV1MsgExecLegacyContent {
    ...
    returns (Data memory, uint)
  {
    ...
    while (pointer < offset + sz) {
      ...
      if (fieldId == 2) {
        pointer += _read_authority(pointer, bs, r);
      } else
      {
        pointer += ProtoBufRuntime._skip_field_decode(wireType, pointer, bs);
      }
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_string(r.authority, pointer, bs);
    }
    return pointer - offset;
  }
  // nested encoder
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.authority).length);
    return e;
  }
  // empty checker
...
library CosmosGovV1MsgExecLegacyContentResponse {
...
library CosmosGovV1MsgVoteResponse {
...
library CosmosGovV1MsgVoteWeighted {
    ...
    returns (Data memory, uint)
  {
    ...
    if (counters[3] > 0) {
      ...
      r.options = new CosmosGovV1WeightedVoteOption.Data[](counters[3]);
    }
...
library CosmosGovV1MsgVoteWeightedResponse {
...
library CosmosGovV1MsgDepositResponse {
